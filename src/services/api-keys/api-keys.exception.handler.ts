...
export enum ApiKeyErrorCodes {
  ...
  API_KEY_ALREADY_ACTIVATE = 'API_KEY_ALREADY_ACTIVATE',
  API_KEY_PERMISSIONS_ASSIGN_FAILED = 'API_KEY_PERMISSIONS_ASSIGN_FAILED',
  API_KEY_CACHE_INVALIDATION_FAILED = 'API_KEY_CACHE_INVALIDATION_FAILED',
}
